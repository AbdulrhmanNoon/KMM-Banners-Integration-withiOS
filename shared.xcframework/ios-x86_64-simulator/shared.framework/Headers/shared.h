...
@class SharedBannerModelCompanion, SharedBannerModel, SharedBannerResponseCompanion, SharedBannerResponse, SharedKotlinThrowable, SharedKotlinArray<T>, SharedKotlinException, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinx_serialization_coreSerialKind, SharedKotlinNothing;

@protocol SharedKotlinx_serialization_coreKSerializer, SharedApi, SharedKotlinx_serialization_coreEncoder, SharedKotlinx_serialization_coreSerialDescriptor, SharedKotlinx_serialization_coreSerializationStrategy, SharedKotlinx_serialization_coreDecoder, SharedKotlinx_serialization_coreDeserializationStrategy, SharedKotlinx_serialization_coreCompositeEncoder, SharedKotlinAnnotation, SharedKotlinx_serialization_coreCompositeDecoder, SharedKotlinIterator, SharedKotlinx_serialization_coreSerializersModuleCollector, SharedKotlinKClass, SharedKotlinKDeclarationContainer, SharedKotlinKAnnotatedElement, SharedKotlinKClassifier;
...
__attribute__((swift_name("AppData")))
@protocol SharedAppData
@required
@property BOOL someBoolean __attribute__((swift_name("someBoolean")));
@property float someFloat __attribute__((swift_name("someFloat")));
@property int32_t someInt __attribute__((swift_name("someInt")));
@property int64_t someLong __attribute__((swift_name("someLong")));
@property (readonly) NSString *someSecureString __attribute__((swift_name("someSecureString")));
@property NSString *someString __attribute__((swift_name("someString")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BannerModel")))
@interface SharedBannerModel : SharedBase
- (instancetype)initWithImage:(NSString * _Nullable)image isVisible:(NSString * _Nullable)isVisible link:(NSString * _Nullable)link duration:(SharedInt * _Nullable)duration sortIndex:(SharedInt * _Nullable)sortIndex updated_at:(NSString * _Nullable)updated_at created_at:(NSString * _Nullable)created_at __attribute__((swift_name("init(image:isVisible:link:duration:sortIndex:updated_at:created_at:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedBannerModelCompanion *companion __attribute__((swift_name("companion")));
...
- (SharedBannerModel *)doCopyImage:(NSString * _Nullable)image isVisible:(NSString * _Nullable)isVisible link:(NSString * _Nullable)link duration:(SharedInt * _Nullable)duration sortIndex:(SharedInt * _Nullable)sortIndex updated_at:(NSString * _Nullable)updated_at created_at:(NSString * _Nullable)created_at __attribute__((swift_name("doCopy(image:isVisible:link:duration:sortIndex:updated_at:created_at:)")));
...
@property (readonly) NSString * _Nullable isVisible __attribute__((swift_name("isVisible")));
@property (readonly) NSString * _Nullable link __attribute__((swift_name("link")));
@property (readonly) SharedInt * _Nullable sortIndex __attribute__((swift_name("sortIndex")));
@property (readonly) NSString * _Nullable updated_at __attribute__((swift_name("updated_at")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BannerModel.Companion")))
@interface SharedBannerModelCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedBannerModelCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BannerResponse")))
@interface SharedBannerResponse : SharedBase
- (instancetype)initWithData:(NSArray<SharedBannerModel *> *)data __attribute__((swift_name("init(data:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedBannerResponseCompanion *companion __attribute__((swift_name("companion")));
- (NSArray<SharedBannerModel *> *)component1 __attribute__((swift_name("component1()")));
- (SharedBannerResponse *)doCopyData:(NSArray<SharedBannerModel *> *)data __attribute__((swift_name("doCopy(data:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<SharedBannerModel *> *data __attribute__((swift_name("data")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BannerResponse.Companion")))
@interface SharedBannerResponseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedBannerResponseCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MainScreen")))
@interface SharedMainScreen : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
*/
- (void)getBannersBaseUrl:(NSString *)baseUrl token:(NSString *)token completionHandler:(void (^)(SharedBannerResponse * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getBanners(baseUrl:token:completionHandler:)")));
@end;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("APIImplementation")))
@interface SharedAPIImplementation : SharedBase <SharedApi>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
